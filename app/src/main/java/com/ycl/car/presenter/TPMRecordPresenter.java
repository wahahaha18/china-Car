...
public class TPMRecordPresenter implements TPMRecordContract.Presenter {
    private static final String TAG = "PmRecordPresenter";
    private TPMRecordContract.View view;

    public TPMRecordPresenter(TPMRecordContract.View view) {
        this.view = view;
    ...
    public void initData(String uid, String eqno) {
        view.showLoading();
        HttpManager.getInstance().getHttpService().getTPMListPlan(uid, eqno)
