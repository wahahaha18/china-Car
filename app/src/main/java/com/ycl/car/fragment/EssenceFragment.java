...
public class EssenceFragment extends BasePageFragment implements PostContract.View {
    ...
    @BindView(R.id.rv_news_essence)
    RecyclerView rvNewsEssence;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvNewsEssence.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvNewsEssence.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
    ...
    public void onSuccess(final List<Post.BBean> list) {
        ...
        rvNewsEssence.setAdapter(adapter);

        rvNewsEssence.addOnItemTouchListener(new OnItemChildClickListener() {
            @Override
