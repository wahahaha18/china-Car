...
public class TPMFragment extends BasePageFragment {
    ...
    public static TPMFragment newInstance() {
        TPMFragment fragment = new TPMFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(TpmCheckFragment.newInstance(String.valueOf(userInfo.getId()), null, 1));
        fragmentList.add(TpmCheckFragment.newInstance(String.valueOf(userInfo.getId()), null, 0));
